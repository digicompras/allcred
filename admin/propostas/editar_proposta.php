...
<table width="100%" border="0" cellspacing="4">
    ...
    <tr>
      ...
      <td><strong><font color="#0000FF">        
        <select class='class02' name="estabelecimento_proposta" id="select8">
...
?>
    ...
    <tr>
      ...
      <td><strong><font color="#0000FF">      
        <select class='class02' name="tipo" id="select9">
...
?>
      ...
      <td><strong><font color="#0000FF">        
        <select class='class02' name="tipo_proposta" id="select11">
...
?>
    ...
    <tr>
      ...
      <td>Valor parcela </td>
      <td><input class='class02' name="parcela" type="text" id="parcela" value="<? echo $parcela; ?>"></td>
    </tr>
    <tr>
