...
<table width="100%" border="0" cellspacing="4">
    ...
    <tr>
      ...
      <td colspan="4"><div align="center"><font color="#0000FF" size="4">EDITANDO PROPOSTA N&ordm; <strong><? echo $num_proposta; ?>
                ...
                <input class='class02' name="num_proposta" type="hidden" id="num_proposta" value="<? echo $num_proposta; ?>">
    ...
    <tr>
      ...
      <td width="18%"><strong><font color="#0000FF">
		  ...
		  if($status=="PAGO AO CLIENTE"){ 
			  ...
			  echo "<input class='class02' name='status' type='hidden' id='status' value='$status'>";
    ...
    //$sql = "select * from status where setor = 'CONSIGNADO' and status <> 'PAGO AO CLIENTE' and status <> 'REPROVADO' and status <> 'ANALISE CIP' and status <> 'ANALISE PAGAMENTO' order by status asc";
			  
	$sql = "select * from status where admin = 'sim' order by status asc";
...
?>
        ...
        <input class='class02' name="mes_ano_status" type="hidden" id="mes_ano_status" value="<? echo date('m-Y'); ?>">
    ...
    <tr>
      ...
      <td><input class='class02' name="nome_operador" type="hidden" id="nome_operador" value="<? echo $nome_operador; ?>">
        <strong><font color="#0000FF">
        <? //echo "Será calculado"; ?>
        <input class='class02' name="retorno" type="hidden" id="retorno2" value="<? $calculo = bcmul($valor_credito, $spread, 2)/14400.00; $calculo_spread = bcmul($calculo,100,2); echo $calculo_spread; ?>">
        <? //$calculo2 = bcmul($valor_credito, $spread, 2)/14400.00; $calculo_spread2 = bcmul($calculo2,100,2); echo $calculo_spread2;?>
        <input class='class02' name="percentual_op" type="hidden" id="percentual_op2" value="<? echo $percentual_op; ?>">
        <input class='class02' name="campanha" type="hidden" id="campanha" value="<? if($campanha_gravada==""){echo "selecione"; } else{echo $campanha_gravada; } ?>">
      </font></strong></td>
      ...
      <td><strong><font color="#0000FF"><? echo $cpf; ?>
            <input class='class02' name="cpf" type="hidden" id="cpf2" value="<? echo $cpf; ?>">
      </font></strong></td>
    ...
    <tr>
      ...
      <td><strong><font color="#0000FF">
        ...
        <input class='class02' name="valor_liberado" type="hidden" id="valor_liberado" value="<? echo $valor_liberado; ?>">
      </font></strong></td>
...
?>
        ...
        <? //echo $quoeficiente; ?>
            <input class='class02' name="quoeficiente" type="hidden" id="quoeficiente" value="<? echo $quoeficiente; ?>">
      </font><font color="#0000FF">
      <input class='class02' name="comissao_op" type="hidden" id="comissao_op" value="<? echo bcmul($valor_credito, $percentual_op, 2); ?>">
      <input class='class02' name="valor_a_receber" type="hidden" id="valor_a_receber" value="<? echo bcmul($valor_credito, $quoeficiente, 2); ?>">
      <input class='class02' name="valor_a_receber_comparativo" type="hidden" id="valor_a_receber_comparativo" value="<?
...
echo "$ano_parc";
      ...
      <input class='class02' name="percentual_entrada" type="hidden" id="percentual_entrada" value="0"></td>
...
?>
         ...
         <input class='class02' name="venctocontrato" type="hidden" id="venctocontrato" value="<? echo $venctocontrato; ?>">
         <input class='class02' name="dia_vencto_contrato" type="hidden" id="dia_vencto_contrato" value="<? echo $dia_vencto_contrato; ?>">
         <input class='class02' name="mes_vencto_contrato" type="hidden" id="mes_vencto_contrato" value="<? echo $mes_vencto_contrato; ?>">
         <input class='class02' name="ano_vencto_contrato" type="hidden" id="ano_vencto_contrato" value="<? echo $ano_vencto_contrato; ?>"></td>
    ...
    <tr>
      ...
      <td colspan="2"><textarea class='class02' name="obs2" cols="45" rows="7" id="obs2"><? echo $obs3; ?></textarea></td>
...
$reg=0;
    ...
    <tr>
      ...
      <td colspan="2"><strong><font color="#0000FF">
        ...
        <input class='class02' name="data_pagto_cliente" type="hidden" id="data_pagto_cliente" value="<? echo date('d-m-Y'); ?>">
        <input class='class02' name="hora_pagto_cliente" type="hidden" id="hora_pagto_cliente" value="<? echo $hora_atual; ?>">
        <input class='class02' name="dataalteracao" type="hidden" id="dataalteracao" value="<? echo date('d-m-Y'); ?>">

        <input class='class02' name="horaalteracao" type="hidden" id="horaalteracao" value="<? echo date('H:i:s'); ?>">

        <input class='class02' name="operador_alterou" type="hidden" id="operador3" value="<? echo $operador_alterou; ?>">

        <input class='class02' name="cel_operador_alterou" type="hidden" id="cel_operador_alterou" value="<? echo $cel_operador_alterou; ?>">

        <input class='class02' name="email_operador_alterou" type="hidden" id="email_operador_alterou" value="<? echo $email_operador_alterou; ?>">

        <input class='class02' name="estabelecimento_alterou" type="hidden" id="estabelecimento_alterou" value="<? echo $estab_pertence; ?>">

        <input class='class02' name="cidade_estabelecimento_alterou" type="hidden" id="cidade_estabelecimento_alterou" value="<? echo $cidade_estab_pertence; ?>">

        <input class='class02' name="tel_estabelecimento_alterou" type="hidden" id="tel_estabelecimento_alterou" value="<? echo $tel_estab_pertence; ?>">

        <input class='class02' name="email_estabelecimento_alterou" type="hidden" id="email_estabelecimento_alterou" value="<? echo $email_estab_pertence; ?>">

        <input class='class02' name="recebido" type="hidden" id="recebido" value="<? echo Não; ?>">
...
?>
        <input class='class02' type="submit" name="Submit" value="Salvar"></td><td><div align="right"> </div></td>
