...
<table width="100%" border="0" cellspacing="4">
    <tr>
      <td colspan="4"><div align="center"><font color="#0000FF" size="4">EDITANDO PROPOSTA N&ordm; <strong><? echo $num_proposta; ?>
                <input class='class02' name="num_proposta" type="hidden" id="nome_operador" value="<? echo $num_proposta; ?>">
      </strong></font></div></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
    ...
    <tr> 
      ...
      <td><strong><font color="#0000FF"><? echo $nome_operador; ?>
            <input class='class02' name="nome_operador" type="hidden" id="nome_operador3" value="<? echo $nome_operador; ?>">
      </font></strong></td>
    ...
    <tr>
      ...
      <td><strong><font color="#0000FF"> <? echo $estabelecimento_proposta; ?> 
        <input class='class02' name="estabelecimento_proposta" type="hidden" id="estabelecimento_proposta" value="<? echo $estabelecimento_proposta; ?>">
      </font></strong></td>
      <td>Status</td>
      <td><strong><font color="#0000FF"> <? echo $status; ?>
        <input class='class02' name="status" type="hidden" id="nome_operador5" value="<? echo $status; ?>">
      </font></strong></td>
    </tr>
    <tr>
      <td>Perfil do cliente </td>
      <td><strong><font color="#0000FF"> <? echo $tipo; ?> 
        <input class='class02' name="tipo" type="hidden" id="nome_operador4" value="<? echo $tipo; ?>">
      </font></strong> </td>
      <td>Tipo da proposta </td>
      <td><strong><font color="#0000FF"> <? echo $tipo_proposta; ?> 
        <input class='class02' name="tipo_proposta" type="hidden" id="nome_operador6" value="<? echo $tipo_proposta; ?>">
      </font></strong></td>
    </tr>
    <tr>
      <td>Nome</td>
...
$reg=0;
    ...
    <tr>
      <td colspan="2"><strong><font color="#0000FF">
        ...
        <input class='class02' name="estabelecimento_alterou" type="hidden" id="estabelecimento_alterou" value="<? echo $estabelecimento_alterou; ?>">
        <input class='class02' name="cidade_estabelecimento_alterou" type="hidden" id="cidade_estabelecimento_alterou" value="<? echo $cidade_estabelecimento_alterou; ?>">
        <input class='class02' name="tel_estabelecimento_alterou" type="hidden" id="tel_estabelecimento_alterou" value="<? echo $tel_estabelecimento_alterou; ?>">
        <input class='class02' name="email_estabelecimento_alterou" type="hidden" id="email_estabelecimento_alterou" value="<? echo $email_estabelecimento_alterou; ?>">
      </font></strong></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
