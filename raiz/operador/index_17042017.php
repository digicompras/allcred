					...
					echo "
						<form name='form1' method='post' action='/verifica.php' target='_top'>
							...
							<article class='columns large-6 box'>";
								if ( $hora_atual <= $hora_iniciar ) { echo "<h4>Prezado operador! Seu dia de trabalho ainda n&atilde;o teve inicio!<br><br>O sistema abrir&aacute; as ".$hora_iniciar." </h4>"; }
						...
						echo "<article class='columns large-6 pull-3 box'><p>ATENÇÃO!!!...<br><br>O IP <strong>". $ip ."</strong> DO LOCAL DE ONDE VOCÊ ESTÁ TENTANDO ACESSAR O SISTEMA NÃO ESTÁ AUTORIZADO PELA EMPRESA!<br><br> ACESSE O SISTEMA DE UM LOCAL DEVIDAMENTE AUTORIZADO!</p>";
					}
				?>
			</article>
			<!-- Script de Operador -->
