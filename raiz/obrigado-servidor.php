...
<body>
	<div class="container">
		<aside>
			<header>
				<div id="logo">
					<div id="contact-phone">(16) 3409-6454</div>
					<div class="toggle-topbar menu-icon"><a href="#">☰ menu</a></div>
				</div>
				<nav id="mainmenu">
					<ul>
						...
						<li class="has-dropdown">
							...
							<ul class="dropdown">
								<li class="first"><a href="produtos/emprestimo-servidores-estado-de-sao-paulo-sp" title="" class="">Empréstimo Servidores de São Paulo</a></li>
								...
								<li class=""><a href="produtos/credito-pessoal" title="" class="">Crédito Pessoal</a></li>
								<li class=""><a href="produtos/refinanciamento-de-imoveis-e-com-a-allcred" title="" class="">Refinanciamento de Imóveis</a></li>
								<li class="last"><a href="/produtos/cartao-de-credito-bradescard" title="" class="">Cartões Bradesco</a></li>
							</ul>
						</li>
			...
			<div id="adbanner">
				<img src="images/banner-sidebar-02.png">
			</div>
			<div id="partners">
				<h3>Parceiros</h3>
				...
				<div class="large-12">
					<div id="slider">
						<figure style="width:100%; animation: 6s slidy1 infinite; -webkit-animation: 6s slidy1 infinite;">
							<img src="images/paginas/slide-obrigado.png" style="width: 100%">
						</figure>
					</div>
					<!-- Main Content -->
					<article class="columns">
						<h2>OLá Servidor! Agradecemos seu Contato.</h2>
						<h2>ENTRAREMOS EM CONTATO EM ATÉ 72h.</h2>
						<div class="large-8 columns">
							<?php
								$num_proposta = $_GET['proposta'];
								if ($num_proposta) {
									echo '<p>O número da sua proposta é<br><span style="color: #1bb852; font-size: 3.5rem;">'. $num_proposta .'</span><p><hr>';
								}
							?>
							<div class="box"><h3>IMPORTANTE: VOCÊ RECEBERÁ UMA MENSAGEM VIA SMS NO SEU CELULAR COM A RESPOSTA DA SUA PROPOSTA</h3></div>
							<p>IMPORTANTE: Se você Solicitou o EMPRÉSTIMO / PORTABILIDADE você deve enviar para o email sac@allcredpromotora.com.br os seguintes documentos:</p> 
							<ul>
							<li>Cópia do Seu CPF</li>
							<li>Cópia do RG</li>
							<li>Cópia do Comprovante de Endereço</li>
							<li>Copia do Comprovante de Renda ou Holerite</li>
							</ul>
							<p>IMPORTANTE: Se você Solicitou o CARTÃO CONSIGNADO você deve enviar para o email sac@allcredpromotora.com.br os seguintes documentos:</p> 
							<ul>
							<li>Cópia do Seu CPF</li>
							<li>Cópia do RG</li>
							<li>Cópia do Comprovante de Endereço</li>
							<li>Copia do Comprovante de Renda ou Holerite</li>
							<li>1 Foto Sua tirada via Celular tipo Selfie</li>
							</ul>
							<p>A Veracidade das informações apresentadas no ato da solicitação implica diretamente na agilidade de sua analise e resposta de sua solicitação de simulação.</p>
                            <p>Entraremos em contato agora por<strong> EMAIL </strong> ou por Telefone que você informou.</p>
                            <p>Fique atento à caixa postal do seu email. Vamos enviar no seu email o LIMITE PRÉ APROVADO</p>
                            <p>Atendimento de SEG a SEX em horário comercial.</p>
        ...
        <footer class="large-12 columns">
            ...
            <div class="large-4 columns">
                ...
                <p>
                    ...
                    Franca - Sao_Paulo<br>
                    14400-730<br />
                    <a href="tel:16 3722 0269"><strong>(16) 3409-6454</strong></a><br>
        	...
        	-->
            <div class="large-4 columns">
                <p class="big-phone center">(16) 3409-6454</p>
                <p class="center">
                    © 2014 - ALL Cred promotora.<br>
                    Todos os direitos reservados.<br>
                    Desenvolvido por <a href="http://www.dinaweb.com.br" target="_blank">Dinaweb Marketing Digital</a>
                </p>
            </div>
        </footer>
    </div>
