...
$sql = "SELECT * FROM clientes where cidade = '$cidade' and secretaria = '$secretaria' order by nome asc";
$res = mysql_query($sql);
...
$sql2 = "SELECT * FROM clientes where cidade = '$cidade' and secretaria = '$secretaria' and cpf <> '' order by nome asc";
...
$html .= '<table>';
$html .= '<tr>';
$html .= '<td><div align="center"><b>Codigo</b></div></td>';
...
$html .= '<tr>';
$html .= '<td><div align="center">'."$codigo".'</div></td>';
