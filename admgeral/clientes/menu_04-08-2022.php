...
?>                    </td>
    ...
    <tr>
      ...
      <td width="32%"><strong><font color="#0000FF" size="4">O que deseja fazer com os clientes?</font></strong></td>
      <td width="55%">&nbsp;</td>
    </tr>
...
?>
    ...
    <tr>
      <td>&nbsp;</td>
      <td><form action="editar_cliente_por_email.php" method="post" name="form5">
        <?
