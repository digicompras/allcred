...
require '../../conect/conect.php';
 ...
 ?>
    ...
    <tr>
      <td width="19%">&nbsp;</td>
      <td colspan="4"><strong><font color="#0000FF" size="4">O que deseja fazer no ESTOQUE?</font></strong></td>
    </tr>
    <tr>
...
?>
    ...
    <tr>
      ...
      <td width="36%"><form name="form2" method="post" action="entrada.php">
...
?>
      ...
      <td width="20%"><form name="form3" method="post" action="../lista_de_compras/selecione_fornecedor_para_abrir_orcamento.php">
        <input type="submit" name="Submit5" value="Lista de compras por Fornecedor">
        <span class="style1">
          <?
$usuario = $_SESSION['usuario'];
$senha = $_SESSION['senha'];
...
?>
      ...
      <td><form name="form3" method="post" action="../lista_de_compras/listagem_geral_para_compras.php">
        <input type="submit" name="Submit6" value="Lista de compras (visualizacao geral)">
        <span class="style1">
          <?
$usuario = $_SESSION['usuario'];
$senha = $_SESSION['senha'];
...
if($preco_compra<=$preco_compra_cadastrado){


$totaliza_quantidade = $quantidade;
...
<?  //echo $quant_estoque; ?>
<input name="quantidade" type="text" id="quantidade" value="<? echo $quant_estoque; ?>" size="4">
