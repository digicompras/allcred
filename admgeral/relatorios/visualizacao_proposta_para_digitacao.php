...
$naturalidade = $linha[115];
	...
	if(empty($vinculo)){
$sql = "SELECT * FROM propostasanaliseportabilidade where num_proposta = '$num_da_proposta' and linha = '1' limit 1";
	}
	else{
$sql = "SELECT * FROM propostasanaliseportabilidade where num_proposta = '$vinculo' and linha = '1' limit 1";
	}
$res = mysql_query($sql);
while($linha=mysql_fetch_row($res)) {
...
$linha_portabilidade1 = $linha[13];
$numcontrato1 = $linha[14];
}

	
	
	if(empty($vinculo)){
$sql = "SELECT * FROM propostasanaliseportabilidade where num_proposta = '$num_da_proposta' and linha = '2' limit 1";
	}
	else{
$sql = "SELECT * FROM propostasanaliseportabilidade where num_proposta = '$vinculo' and linha = '2' limit 1";
	}
$res = mysql_query($sql);
while($linha=mysql_fetch_row($res)) {
...
$linha_portabilidade2 = $linha[13];
	$numcontrato2 = $linha[14];
}
	...
	if(empty($vinculo)){
$sql = "SELECT * FROM propostasanaliseportabilidade where num_proposta = '$num_da_proposta' and linha = '3' limit 1";
	}
	else{
$sql = "SELECT * FROM propostasanaliseportabilidade where num_proposta = '$vinculo' and linha = '3' limit 1";
	}
$res = mysql_query($sql);
while($linha=mysql_fetch_row($res)) {
...
$linha_portabilidade3 = $linha[13];
	$numcontrato3 = $linha[14];
}

	
	if(empty($vinculo)){
$sql = "SELECT * FROM propostasanaliseportabilidade where num_proposta = '$num_da_proposta' and linha = '4' limit 1";
	}
	else{
$sql = "SELECT * FROM propostasanaliseportabilidade where num_proposta = '$vinculo' and linha = '4' limit 1";
	}
$res = mysql_query($sql);
while($linha=mysql_fetch_row($res)) {
...
$linha_portabilidade4 = $linha[13];
	$numcontrato4 = $linha[14];
}
	
	if(empty($vinculo)){
$sql = "SELECT * FROM propostasanaliseportabilidade where num_proposta = '$num_da_proposta' and linha = '5' limit 1";
	}
	else{
$sql = "SELECT * FROM propostasanaliseportabilidade where num_proposta = '$vinculo' and linha = '5' limit 1";
	}
$res = mysql_query($sql);
while($linha=mysql_fetch_row($res)) {
...
$linha_portabilidade5 = $linha[13];
	$numcontrato5 = $linha[14];
}
	
	if(empty($vinculo)){
$sql = "SELECT * FROM propostasanaliseportabilidade where num_proposta = '$num_da_proposta' and linha = '6' limit 1";
	}
	else{
$sql = "SELECT * FROM propostasanaliseportabilidade where num_proposta = '$vinculo' and linha = '6' limit 1";
	}
$res = mysql_query($sql);
while($linha=mysql_fetch_row($res)) {
...
$linha_portabilidade6 = $linha[13];
	$numcontrato6 = $linha[14];
}

	if(empty($vinculo)){
$sql = "SELECT * FROM propostasanaliseportabilidade where num_proposta = '$num_da_proposta' and linha = '7' limit 1";
	}
	else{
$sql = "SELECT * FROM propostasanaliseportabilidade where num_proposta = '$vinculo' and linha = '7' limit 1";
	}
$res = mysql_query($sql);
while($linha=mysql_fetch_row($res)) {
...
$linha_portabilidade7 = $linha[13];
	$numcontrato7 = $linha[14];
}
	
	if(empty($vinculo)){
$sql = "SELECT * FROM propostasanaliseportabilidade where num_proposta = '$num_da_proposta' and linha = '8' limit 1";
	}
	else{
$sql = "SELECT * FROM propostasanaliseportabilidade where num_proposta = '$vinculo' and linha = '8' limit 1";
	}
$res = mysql_query($sql);
while($linha=mysql_fetch_row($res)) {
...
$linha_portabilidade8 = $linha[13];
	$numcontrato8 = $linha[14];
}
	
	if(empty($vinculo)){
$sql = "SELECT * FROM propostasanaliseportabilidade where num_proposta = '$num_da_proposta' and linha = '9' limit 1";
	}
	else{
$sql = "SELECT * FROM propostasanaliseportabilidade where num_proposta = '$vinculo' and linha = '9' limit 1";
	}
$res = mysql_query($sql);
while($linha=mysql_fetch_row($res)) {
...
$linha_portabilidade9 = $linha[13];
	$numcontrato9 = $linha[14];
}
	
	if(empty($vinculo)){
$sql = "SELECT * FROM propostasanaliseportabilidade where num_proposta = '$num_da_proposta' and linha = '10' limit 1";
	}
	else{
$sql = "SELECT * FROM propostasanaliseportabilidade where num_proposta = '$vinculo' and linha = '10' limit 1";
	}
$res = mysql_query($sql);
while($linha=mysql_fetch_row($res)) {
...
$tipooperacao10 = $linha[11];
	$linha_portabilidade10 = $linha[13];
	$numcontrato10 = $linha[14];
...
//require_once('../../sistem/propostas/barcode.inc.php'); 
	...
	//echo '<img src="'.$num_proposta.'.gif" />';
		  echo "$num_da_proposta $tipovenda";
?>
      </font></strong>
          <input type='hidden' name='num_proposta' id='num_proposta' value='<? echo "$num_da_proposta"; ?>'>
          <input type='hidden' name='vinculo' id='vinculo' value='<? echo "$vinculo"; ?>'>
          <input type='hidden' name='tipovenda' id='tipovenda' value='<? echo "Filha da $num_da_proposta"; ?>'>
      </div>
...
$reg=0;
	   ...
	   ?>
          ...
          <tr>
			...
			if($linha_controle==$linha_portabilidade1){
			include 't1.php';
			}}
			?>
			...
			if($linha_controle==$linha_portabilidade2){ 
          include 't2.php';
			 } } 
			?>
			...
			if($linha_controle==$linha_portabilidade3){ 
         include 't3.php';
		 } } 
			?>
			...
			if($linha_controle==$linha_portabilidade4){ 
          include 't4.php';
			} } 
			?>
			...
			if($linha_controle==$linha_portabilidade5){ 
				include 't5.php'; 
			} } 
			?>
			...
			if($linha_controle==$linha_portabilidade6){ 
         include 't6.php';
			} } 
			?>
			...
			if($linha_controle==$linha_portabilidade7){ 
          include 't7.php';
			 } } 
			?>
			...
			if($linha_controle==$linha_portabilidade8){ 
          include 't8.php';
			} } 
			?>
			...
			if($linha_controle==$linha_portabilidade9){
         include 't9.php';
			} } 
			?>
			...
			if($linha_controle==$linha_portabilidade10){
		include 't10.php';
			} } 
			?>
...
<?
function gerarTabelaPropostaDigitacao1($parc1,$banco1,$vencto1,$parcelaspagas1,$taxajuros1,$numcontrato1,$valorliberado1,$bancodigitacao,$tipooperacao1){
?>
	<tr>
		...
		<td align="center" valign="baseline"><input name="valorliberado1" type="text" class='class02' id="valorliberado1" value="<? echo "$valorliberado1"; ?>" size="5">
	  	<input name="linha1" type="hidden" class='class02' id="linha1" value="2" size="5" readonly="readonly"></td>
...
<?
function gerarTabelaPropostaDigitacao2($parc2,$banco2,$vencto2,$parcelaspagas2,$taxajuros2,$numcontrato2,$valorliberado2,$bancodigitacao2,$tipooperacao2){
?>
	<tr>
...
<?
function gerarTabelaPropostaDigitacao3($parc3,$banco3,$vencto3,$parcelaspagas3,$taxajuros3,$numcontrato3,$valorliberado3,$bancodigitacao3,$tipooperacao3){
?>
	<tr>
		...
		<td align="center" valign="baseline"><input name="valorliberado3" type="text" class='class02' id="valorliberado3" value="<? echo "$valorliberado3"; ?>" size="5">
	  	<input name="linha3" type="hidden" class='class02' id="linha3" value="2" size="5" readonly="readonly"></td>
		<td align="center" valign="baseline"><strong><font color="#0000FF">
...
<?
function gerarTabelaPropostaDigitacao4($parc4,$banco4,$vencto4,$parcelaspagas4,$taxajuros4,$numcontrato4,$valorliberado4,$bancodigitacao4,$tipooperacao4){
?>
	<tr>
		...
		<td align="center" valign="baseline"><input name="valorliberado4" type="text" class='class02' id="valorliberado4" value="<? echo "$valorliberado4"; ?>" size="5">
	  	<input name="linha4" type="hidden" class='class02' id="linha4" value="2" size="5" readonly="readonly"></td>
		<td align="center" valign="baseline"><strong><font color="#0000FF">
...
<?
function gerarTabelaPropostaDigitacao5($parc5,$banco5,$vencto5,$parcelaspagas5,$taxajuros5,$numcontrato5,$valorliberado5,$bancodigitacao5,$tipooperacao5){
?>
	<tr>
		...
		<td align="center" valign="baseline"><input name="valorliberado5" type="text" class='class02' id="valorliberado5" value="<? echo "$valorliberado5"; ?>" size="5">
	  	<input name="linha5" type="hidden" class='class02' id="linha5" value="2" size="5" readonly="readonly"></td>
		<td align="center" valign="baseline"><strong><font color="#0000FF">
...
<?
function gerarTabelaPropostaDigitacao6($parc6,$banco6,$vencto6,$parcelaspagas6,$taxajuros6,$numcontrato6,$valorliberado6,$bancodigitacao6,$tipooperacao6){
?>
	<tr>
		...
		<td align="center" valign="baseline"><input name="valorliberado6" type="text" class='class02' id="valorliberado6" value="<? echo "$valorliberado6"; ?>" size="5">
	  	<input name="linha6" type="hidden" class='class02' id="linha6" value="2" size="5" readonly="readonly"></td>
		<td align="center" valign="baseline"><strong><font color="#0000FF">
...
<?
function gerarTabelaPropostaDigitacao7($parc7,$banco7,$vencto7,$parcelaspagas7,$taxajuros7,$numcontrato7,$valorliberado7,$bancodigitacao7,$tipooperacao7){
?>
	<tr>
		...
		<td align="center" valign="baseline"><input name="valorliberado7" type="text" class='class02' id="valorliberado7" value="<? echo "$valorliberado7"; ?>" size="5">
	  	<input name="linha7" type="hidden" class='class02' id="linha7" value="2" size="5" readonly="readonly"></td>
		<td align="center" valign="baseline"><strong><font color="#0000FF">
...
<?
function gerarTabelaPropostaDigitacao8($parc8,$banco8,$vencto8,$parcelaspagas8,$taxajuros8,$numcontrato8,$valorliberado8,$bancodigitacao8,$tipooperacao8){
?>
	<tr>
		...
		<td align="center" valign="baseline"><input name="valorliberado8" type="text" class='class02' id="valorliberado8" value="<? echo "$valorliberado8"; ?>" size="5">
	  	<input name="linha8" type="hidden" class='class02' id="linha8" value="2" size="5" readonly="readonly"></td>
		<td align="center" valign="baseline"><strong><font color="#0000FF">
...
<?
function gerarTabelaPropostaDigitacao9($parc9,$banco9,$vencto9,$parcelaspagas9,$taxajuros9,$numcontrato9,$valorliberado9,$bancodigitacao9,$tipooperacao9){
?>
	<tr>
		...
		<td align="center" valign="baseline"><input name="valorliberado9" type="text" class='class02' id="valorliberado9" value="<? echo "$valorliberado9"; ?>" size="5">
	  	<input name="linha9" type="hidden" class='class02' id="linha9" value="2" size="5" readonly="readonly"></td>
		<td align="center" valign="baseline"><strong><font color="#0000FF">
...
<?
function gerarTabelaPropostaDigitacao10($parc10,$banco10,$vencto10,$parcelaspagas10,$taxajuros10,$numcontrato10,$valorliberado10,$bancodigitacao10,$tipooperacao10){
?>
	<tr>
		...
		<td align="center" valign="baseline"><input name="valorliberado10" type="text" class='class02' id="valorliberado10" value="<? echo "$valorliberado10"; ?>" size="5">
	  	<input name="linha10" type="hidden" class='class02' id="linha10" value="2" size="5" readonly="readonly"></td>
		<td align="center" valign="baseline"><strong><font color="#0000FF">
