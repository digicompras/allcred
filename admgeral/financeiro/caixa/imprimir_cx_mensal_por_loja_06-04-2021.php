...
</span> <span class="style1"><? echo $nome_op; ?></span><span class="style2"> verificando os lan&ccedil;amentos do caixa da loja <? echo $nfantasia; ?> no m&ecirc;s <? echo "$mes - $ano"; ?><BR>
	      </span></div></td>
        </tr>
</table>
...
$sql7 = "select sum(valor_total) as total from propostas where mes_alteracao_status = '$mes'  and ano_alteracao_status = '$ano' and status = 'PAGO AO CLIENTE'";
...
$sql8 = "select sum(valor_a_receber) as total from propostas where mes_alteracao_status = '$mes'  and ano_alteracao_status = '$ano' and status = 'PAGO AO CLIENTE'";
...
$sql = "SELECT * FROM propostas where estabelecimento_proposta = '$nfantasia' and mes_alteracao_status = '$mes'  and ano_alteracao_status = '$ano' and status = 'PAGO AO CLIENTE' group by estabelecimento_proposta ";
$res = mysql_query($sql);
while($linha=mysql_fetch_row($res)) {
$reg++;
...
?>
	...
	$sql2 = "select sum(valor_total) as total from propostas where estabelecimento_proposta = '$nfantasia' and mes_alteracao_status = '$mes_alteracao_status'  and ano_alteracao_status = '$ano_alteracao_status' and status = 'PAGO AO CLIENTE'";
...
echo "<br> ($percetualdecontribuicaodaagenciaparvalortotal2%)";
	...
	$sql3 = "select sum(valor_a_receber) as total from propostas where estabelecimento_proposta = '$nfantasia' and mes_alteracao_status = '$mes_alteracao_status'  and ano_alteracao_status = '$ano_alteracao_status' and status = 'PAGO AO CLIENTE'";
...
?>
                        <?
$sql4 = "SELECT * FROM propostas where mes_alteracao_status = '$mes'  and ano_alteracao_status = '$ano' and estabelecimento_proposta = '$nfantasia' and status = 'PAGO AO CLIENTE' group by nome_operador order by nome_operador asc";
...
?>
	...
	$sql5 = "select sum(valor_total) as total from propostas where estabelecimento_proposta = '$nfantasia' and nome_operador = '$nome_operador' and mes_alteracao_status = '$mes_alteracao_status'  and ano_alteracao_status = '$ano_alteracao_status' and status = 'PAGO AO CLIENTE' ";
...
echo "<br> ($percetualdecontribuicaodooperadorreferenteavalortotalbrutodaagencia2%)";
								...
								?></div></td>
                            <td><div align="center" class="style11"><?
	$sql6 = "select sum(valor_a_receber) as total from propostas where estabelecimento_proposta = '$nfantasia' and nome_operador = '$nome_operador' and mes_alteracao_status = '$mes_alteracao_status'  and ano_alteracao_status = '$ano_alteracao_status' and status = 'PAGO AO CLIENTE' ";
